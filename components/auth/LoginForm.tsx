...
export function LoginForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5" noValidate>
      {showSuccessBanner && (
        <div
          className="flex items-center justify-between rounded-lg border border-emerald-500/30 bg-emerald-500/10 px-4 py-3 text-sm text-emerald-300"
          role="alert"
        >
          ...
          <button
            ...
            className="text-emerald-400 hover:text-emerald-300 font-bold px-2 text-lg leading-none"
            aria-label="Dismiss"
          >
            ×
          </button>
